...
public class P02_HamcrestSpartan extends SpartanTestBase {
    ...
    public void test2(){
        ...
        .when()
                .get("/api/spartans/{id}")
        .then()
                .assertThat() //assertT(), and() these are syntactic sugar just to increase readability
                .statusCode(200)
                .and()
                .contentType("application/json")
                .and()
        ...
        // this test2() and test1 are exactly the same testcase/ we just used more filler(syntactic sugar)keywords to increase readability
    ...
    public void test3(){
        ...
        .then()
                //.log().all()
                .log().ifValidationFails() //to see response all information, if validation fails
                .statusCode(200)
                .contentType("application/json")
                .body("id",is(15),
                        "name",is("Meta"),
    ...
    */
    ...
    public void test4(){
        ...
        //expectedIdDb data from database
        ...
        /*
            Why we need to extract, while we can complete all verification(status code, header, body) with then() and hamcrest matchers
            ...
            --Assume that we are going to do verification against DB/UI. In that case I need to get data from API
             ...
             So we need to sometimes list of names / ids / whatever field we have to check against to db UI
