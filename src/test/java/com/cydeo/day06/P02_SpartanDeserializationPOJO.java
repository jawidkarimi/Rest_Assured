...
public class P02_SpartanDeserializationPOJO extends SpartanTestBase {
    ...
    public void test2(){
        ...
        //response.as("content[0]",Spartan.class) // we can not do with as() method since it does not support path and class type at the same time
    ...
    @DisplayName("GET Spartan from search endpoint for deserialization to Search class")
    @Test
    public void test3(){
        Response response = given()
                .accept(ContentType.JSON)
    ...
    @DisplayName("GET Spartan from search endpoint for deserialization to List of Spartan")
    @Test
    public void test4(){
        Response response = given()
                .accept(ContentType.JSON)
